...
def greedy_motif_search_with_psuedocount(k, t, dnas):
    best_motifs = []
    ...
    for i in range(0, len(dnas[0])-k+1):
        ...
        for j in range(1, t):
            ...
            profile_matrix = profile_motifs(count_matrix, t+(len(motifs)-1)) # number of rows of motifs to divide by
...
def start():
    ...
    result = greedy_motif_search_with_psuedocount(k, t, dnas)
